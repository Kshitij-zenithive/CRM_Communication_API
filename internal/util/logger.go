// internal/util/logger.go (CORRECTED - no longer takes log level as argument)
...
// NewLogger creates a new logger.  LogLevel is now read from environment.
func NewLogger() *Logger {
	...
	return &Logger{
		minLevel: minLevel, // Use the determined level
		out:      os.Stdout,
	}
}
