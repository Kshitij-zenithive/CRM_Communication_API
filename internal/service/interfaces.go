...
type NotificationService interface {
	...
	// BroadcastConversationUpdate(ctx context.Context, conversation *dbmodel.Conversation) error
	// Add methods for other notifications (e.g., mention, reminder trigger)
